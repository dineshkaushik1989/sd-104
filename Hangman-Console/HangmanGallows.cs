...
namespace Hangman_Console
{
    class HangmanGallows
    {
        ...
        /// <summary>
        /// clear the console window and draw the hangman gallows in the stage passed in.
        /// There are 10 stages
        /// </summary>
        /// <param name="wrongGuesses">indicates which stage of the hangman gallow to draw</param>
